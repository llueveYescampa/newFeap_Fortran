...
!     p(*)      - Element vector
   ...
   case (2)
     call elmt02(d,u,x,ix,  s,p,i,j,k,isw)
   case (3)
     call elmt03(d,u,x,ix,  s,p,i,j,k,isw)
   case (4)
     call elmt04(d,u,x,     s,p,i,j,k,isw)
   case (5)
     call elmt05(d,u,x,     s,p,i,j,k,isw)
   case (6)
     call elmt06(d,u,x,ix,  s,p,i,j,k,isw)
   case (7)
