subroutine elmt02(d,ul,xl,ix,   s,p,ndf,ndm,nst,isw)
implicit none
...
!     Compute volumetric integrals
      ...
      do l = 1,lint
        ...
        call gvc02(shp(1,1,l),shp3(1,l),xsj(l),wg(l),xl,tipo,ndm)
      end do ! l
...
!         Compute stress, strain, and material moduli
          ...
          call strn02(shp(1,1,l),xl,ul,tipo,xr0,xz0,ndm,ndf,eps)
